 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceImplService", targetNamespace = "http://service.demo.bingo.com/", wsdlLocation = "http://localhost:8888/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICEIMPLSERVICE_QNAME = new QName("http://service.demo.bingo.com/", "MyWebServiceImplService");
    ...
    public MyWebServiceImpl getMyWebServiceImplPort() {
        return super.getPort(new QName("http://service.demo.bingo.com/", "MyWebServiceImplPort"), MyWebServiceImpl.class);
    }
    ...
    public MyWebServiceImpl getMyWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.demo.bingo.com/", "MyWebServiceImplPort"), MyWebServiceImpl.class, features);
    }
